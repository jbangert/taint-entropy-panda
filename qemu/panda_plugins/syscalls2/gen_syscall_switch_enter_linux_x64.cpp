...
#include "gen_syscall_ppp_register_enter_linux_x64.cpp"  // osarch
}

#include "gen_syscall_ppp_boilerplate_enter_linux_x64.cpp" // osarch

void syscall_enter_switch_linux_x64 ( CPUState *env, target_ulong pc ) {  // osarch
...
default:
PPP_RUN_CB(on_unknown_sys_linux_x64_enter, env, pc, EAX);
}
PPP_RUN_CB(on_all_sys_linux_x64_enter, env, pc, EAX);
#endif
 } 
