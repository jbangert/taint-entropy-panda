...
typedef void (*on_sys_madvise_return_t)(CPUState* env,target_ulong pc,uint32_t start,uint32_t len_in,int32_t behavior);
...
typedef void (*on_sys_shmget_return_t)(CPUState* env,target_ulong pc,uint32_t key,uint32_t size,int32_t shmflg);
...
typedef void (*on_sys_madvise_enter_t)(CPUState* env,target_ulong pc,uint32_t start,uint32_t len_in,int32_t behavior);
...
typedef void (*on_sys_shmget_enter_t)(CPUState* env,target_ulong pc,uint32_t key,uint32_t size,int32_t shmflg);
