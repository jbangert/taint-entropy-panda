...
extern "C" {
#include "gen_syscalls_ext_typedefs_windows7_x64.h"   // osarch
#include "gen_syscall_ppp_register_return_windows7_x64.cpp"  // osarch
}

#include "gen_syscall_ppp_boilerplate_return_windows7_x64.cpp" // osarch

void syscall_return_switch_windows7_x64 ( CPUState *env, target_ulong pc, target_ulong ordinal) {  // osarch
...
default:
PPP_RUN_CB(on_unknown_sys_windows7_x64_return, env, pc, EAX);
}
PPP_RUN_CB(on_all_sys_windows7_x64_return, env, pc, EAX);
#endif
 } 
